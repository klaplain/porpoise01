...
spi.max_speed_hz = 2700000                                             # Set SPI speed and mode  2700000 seems to be the maximum stable value.  2.7MHz clock => 337kBytes/sec theoretical.  5/19 was 12000000 
spi.mode = 0
spi.no_cs = False
...
def stm_to_raspi():                                                     # Get a block of data from the STM32 into the RASPI
    ...
    while True:
        while GPIO.input(26) == GPIO.HIGH  :  pass                      # Wait until STM ACQ is Ready before requesting datablock
...
def directory(): 
    ...
    # directory_line is now an array of each line item
...
if __name__ == "__main__":
    ...
    GPIO.setup(26, GPIO.IN, pull_up_down=GPIO.PUD_UP)                   # STM32 SPI Busy
